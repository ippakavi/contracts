    ...
    PausableUpgradeable
{
    ...
    address public constant saleToken = 0xEB0455312d72119E06663A1ec384DC1B69C40587;
    ...
    function buyWithUSDT(uint256 amount)
        ...
        returns (bool)
    {
        require(amount + totalTokensSold <= 700_000_000, "Exceeds Beta Stage");
    ...
    // Define the event outside of any functions
    event Transfer(address indexed from, address indexed to, uint256 value);

    function transfer(address recipient, uint256 amount) public {
    // Perform the transfer, typically involving updating balances.
    // Ensure that sender's balance is decreased, and recipient's balance is increased.
